      ...
      <div className={classes.container}>
        <div className={classes.root}>
          <Grid container spacing={24}>
            <Grid item xs={6} sm={3}>
              <CardActionArea>
                <Link onClick={() => addInfo('cereal', 'Star')} to='/grocery_lists/new' replace >
            ...
            <Grid item xs={6} sm={3}>
              <CardActionArea>
                <Link onClick={() => addInfo('can', 'Star')} to='/grocery_lists/new' replace >
            ...
            <Grid item xs={6} sm={3}>
              <CardActionArea>
                <Link onClick={() => addInfo('meat', 'Star')} to='/grocery_lists/new' replace >
            ...
            <Grid item xs={6} sm={3}>
              <CardActionArea>
                <Link onClick={() => addInfo('fruit', 'Star')} to='/grocery_lists/new' replace >
            ...
            <Grid item xs={6} sm={3}>
              <CardActionArea>
                <Link onClick={() => addInfo('dairy', 'Star')} to='/grocery_lists/new' replace >
            ...
            <Grid item xs={6} sm={3}>
              <CardActionArea>
                <Link onClick={() => addInfo('bread', 'Star')} to='/grocery_lists/new' replace >
            ...
            <Grid item xs={6} sm={3}>
              <CardActionArea>
                <Link onClick={() => addInfo('frozen', 'Star')} to='/grocery_lists/new' replace >
            ...
            <Grid item xs={6} sm={3}>
              <CardActionArea>
                <Link onClick={() => addInfo('vegetable', 'Star')} to='/grocery_lists/new' replace >
