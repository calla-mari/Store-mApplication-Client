      ...
      <div className={classes.container}>
        <div className={classes.root}>
          <Grid container spacing={24}>
            <Grid item xs={6} sm={3}>
              <CardActionArea>
                <Link onClick={() => addInfo('cereal', 'Costco')} to='/grocery_lists/new' replace >
            ...
            <Grid item xs={6} sm={3}>
              <CardActionArea>
                <Link onClick={() => addInfo('can', 'Costco')} to='/grocery_lists/new' replace >
            ...
            <Grid item xs={6} sm={3}>
              <CardActionArea>
                <Link onClick={() => addInfo('meat', 'Costco')} to='/grocery_lists/new' replace >
            ...
            <Grid item xs={6} sm={3}>
              <CardActionArea>
                <Link onClick={() => addInfo('fruit', 'Costco')} to='/grocery_lists/new' replace >
            ...
            <Grid item xs={6} sm={3}>
              <CardActionArea>
                <Link onClick={() => addInfo('dairy', 'Costco')} to='/grocery_lists/new' replace >
            ...
            <Grid item xs={6} sm={3}>
              <CardActionArea>
                <Link onClick={() => addInfo('bread', 'Costco')} to='/grocery_lists/new' replace >
            ...
            <Grid item xs={6} sm={3}>
              <CardActionArea>
                <Link onClick={() => addInfo('frozen', 'Costco')} to='/grocery_lists/new' replace >
            ...
            <Grid item xs={6} sm={3}>
              <CardActionArea>
                <Link onClick={() => addInfo('vegetable', 'Costco')} to='/grocery_lists/new' replace >
