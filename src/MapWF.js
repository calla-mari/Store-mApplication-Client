      ...
      <div className={classes.container}>
        <div className={classes.root}>
          <Grid container spacing={24}>
            <Grid item xs={6} sm={3}>
              <CardActionArea>
                <Link onClick={() => addInfo('cereal', 'WholeFoods')} to='/grocery_lists/new' replace >
            ...
            <Grid item xs={6} sm={3}>
              <CardActionArea>
                <Link onClick={() => addInfo('can', 'WholeFoods')} to='/grocery_lists/new' replace >
            ...
            <Grid item xs={6} sm={3}>
              <CardActionArea>
                <Link onClick={() => addInfo('meat', 'WholeFoods')} to='/grocery_lists/new' replace >
            ...
            <Grid item xs={6} sm={3}>
              <CardActionArea>
                <Link onClick={() => addInfo('fruit', 'WholeFoods')} to='/grocery_lists/new' replace >
            ...
            <Grid item xs={6} sm={3}>
              <CardActionArea>
                <Link onClick={() => addInfo('dairy', 'WholeFoods')} to='/grocery_lists/new' replace >
            ...
            <Grid item xs={6} sm={3}>
              <CardActionArea>
                <Link onClick={() => addInfo('bread', 'WholeFoods')} to='/grocery_lists/new' replace >
            ...
            <Grid item xs={6} sm={3}>
              <CardActionArea>
                <Link onClick={() => addInfo('frozen', 'WholeFoods')} to='/grocery_lists/new' replace >
            ...
            <Grid item xs={6} sm={3}>
              <CardActionArea>
                <Link onClick={() => addInfo('vegetable', 'WholeFoods')} to='/grocery_lists/new' replace >
        ...
        <div className={classes.containerDoor}>
          <Grid container spacing={24}>
            <Grid item xs={6} sm={3}>
              <CardActionArea className={classes.door2}>
